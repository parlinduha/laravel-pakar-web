...
<body>
      ...
      <div class="container mx-auto">
        <div class="flex flex-wrap">
          <div class="w-full self-center px-4  lg:w-1/2 ">
            ...
            <h1 class="text-4xl decoration-solid decoration-cyan-400 "><b>Lakukan dianosa sekarang ? </b></h1>
    ...
    <!-- service -->
    <section id="services" class="pt-36 bg-white pb-36">
      <div class="container mx-auto">
        <div class="w-full px-4">
          <div class="max-w-xs mx-auto text-center mb-12">
    ...
    <section id="games" class="pt-36 pb-16">
      <div class="container mx-auto">
        ...
        <div class="w-full px-4 flex flex-wrap justify-center ">
          ...
          <div class="mb-12 p-4 lg:w-1/5">
            <div class=" overflow-hidden">
              <img src="img/pubg.jpeg" alt="" class=" ease-in-out rounded-xl shadow-xl">
            </div>
          </div>
        </div>
      </div>
