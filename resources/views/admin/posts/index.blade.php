    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card border-0 shadow rounded">
                <div class="card-body ">
                    <a href="{{ route('posts.create') }}" class="btn btn-md btn-success mb-3"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-square" viewBox="0 0 16 16">
                            ...
                            <tbody>
                              @forelse ($posts as $post)
                                <tr>
                                    ...
                                    <td>{{ $post->title }}</td>
                                    <td>{{ $post->disease->name_disease }}</td>
                                    <td>{!! $post->content !!}</td>
                                    <td class="text-center">
